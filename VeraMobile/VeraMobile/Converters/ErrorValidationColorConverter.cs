...
using VeraMobile.Controls;
using VeraMobile.ViewModels;
using VeraMobile.ViewModels.Forms;
using Xamarin.Forms;
using Xamarin.Forms.Internals;

namespace VeraMobile.Converters
{
    /// <summary>
    ...
    public class ErrorValidationColorConverter : IValueConverter
    {
        ...
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
            ...
            if (PageVariantParameter == "0")
            {
                ...
                if (!(emailEntry?.BindingContext is VeraMobile.ViewModels.LoginViewModel bindingContext))
                {
